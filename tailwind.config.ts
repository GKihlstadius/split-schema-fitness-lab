		...
		extend: {
			...
			keyframes: {
				...
				'level-up': {
					...
					'50%': { transform: 'scale(1.1)', boxShadow: '0 0 30px 10px rgba(59, 130, 246, 0.3)' },
					'100%': { transform: 'scale(1)', boxShadow: '0 0 0 0 rgba(59, 130, 246, 0)' }
				},
				'pulse-glow': {
					'0%, 100%': { boxShadow: '0 0 10px 2px rgba(59, 130, 246, 0.3)' },
					'50%': { boxShadow: '0 0 25px 8px rgba(59, 130, 246, 0.5)' }
				},
				'slide-up': {
				...
				'streak-pulse': {
					'0%, 100%': { textShadow: '0 0 8px rgba(245, 158, 11, 0.5)' },
					'50%': { textShadow: '0 0 20px rgba(245, 158, 11, 0.8)' }
				}
			},
			animation: {
