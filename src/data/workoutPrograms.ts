...
export const workoutPrograms: WorkoutProgram[] = [
  ...
  },
  {
    ...
    duration: '16 WEEKS',
    focus: 'Whole Body Mass Building',
    description: 'Ett avancerat 5-dagars hypertrofiprogram med massfokus för hela kroppen.',
    weeklyPlan: [
      {
        day: 'Måndag',
        ...
        exercises: [
          ...
          { name: 'Cable Fly', sets: '2', reps: '12-15', tags: ['Chest'] },
          { name: 'Lateral Raises', sets: '4', reps: '12-15', tags: ['Shoulders'] },
          { name: 'Rope pushdowns', sets: '2', reps: '12-15', tags: ['Triceps'] },
        ],
      },
      {
        day: 'Tisdag',
        ...
        exercises: [
          ...
          { name: 'Preacher Curls', sets: '2', reps: '12-15', tags: ['Biceps'] },
        ],
      },
      {
        day: 'Onsdag',
        ...
        focus: 'Leg Development',
        exercises: [
          { name: 'Back Squat', sets: '3', reps: '6-8', tags: ['Quads', 'Glutes'] },
          { name: 'Romanian Deadlift', sets: '4', reps: '8-10', tags: ['Hamstrings'] },
          { name: 'Leg Press', sets: '3', reps: '12-15', tags: ['Quads'] },
          { name: 'Leg Curl', sets: '4', reps: '12-15', tags: ['Hamstrings'] },
          { name: 'Hip Abduction Machine', sets: '2', reps: '15-20', tags: ['Glutes'] },
        ],
      },
      {
        day: 'Torsdag',
        muscleGroups: ['Chest', 'Back'],
        focus: 'Upper Density (Chest & Back)',
        exercises: [
          { name: 'Dumbbell Bench Press', sets: '4', reps: '10-12', tags: ['Chest'] },
          { name: 'Cable Row', sets: '3', reps: '10-12', tags: ['Back'] },
          { name: 'Pec Deck', sets: '3', reps: '12-15', tags: ['Chest'] },
          { name: 'Straight-Arm Pulldown', sets: '2', reps: '12-15', tags: ['Back'] },
          { name: 'Rear Delt Fly', sets: '2', reps: '12-15', tags: ['Shoulders'] },
        ],
      },
      {
        day: 'Fredag',
        muscleGroups: ['Quads', 'Shoulders', 'Triceps', 'Biceps', 'Calves'],
        focus: 'Weak Points (Delts, Arms, Calves)',
        exercises: [
          { name: 'Front Squat', sets: '2', reps: '8-10', tags: ['Quads'] },
          { name: 'Arnold Press', sets: '3', reps: '10-12', tags: ['Shoulders'] },
          { name: 'Lateral Raises', sets: '3', reps: '15-20', tags: ['Shoulders'] },
    ...
    benefits: [
      'Avancerat massbyggande 5-dagars upplägg',
      'Strukturerad push/pull/ben samt densitet och svagpunkter',
      'Tydliga hypertrofivolymer med fokus på axlar och vader',
    ],
  }
];
