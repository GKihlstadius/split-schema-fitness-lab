...
export const workoutPrograms: WorkoutProgram[] = [
  ...
  },
  {
    ...
    difficulty: 'Intermediate',
    duration: '12 WEEKS',
    focus: 'Rygg & Biceps, Bröst & Triceps, Ben, Armar, Bröst & Axlar',
    description: 'Tren Twins 5-dagars split: Måndag rygg & biceps, Tisdag vila, Onsdag bröst & triceps, Torsdag ben, Fredag armar (renodlat), Lördag bröst & axlar, Söndag vila.',
    weeklyPlan: [
      {
        day: 'Måndag',
        muscleGroups: ['Back', 'Biceps'],
        focus: 'Rygg & Biceps',
        exercises: [
          { name: 'Pull-ups', sets: '3', reps: '8', rest: '2 min', tags: ['Back'] },
          { name: 'Cable Lat Pulldown (wide grip)', sets: '3', reps: '8', rest: '2 min', tags: ['Back'] },
          { name: 'Cable Rope Deltoid Row', sets: '3', reps: '8', rest: '2 min', tags: ['Back'] },
          { name: 'Machine T-Bar Row (reverse grip)', sets: '3', reps: '8', rest: '2 min', tags: ['Back'] },
          { name: 'Barbell Curl', sets: '4', reps: '8', rest: '2 min', tags: ['Biceps'] },
          { name: 'Dumbbell Alternating Hammer Curl', sets: '3', reps: '8', rest: '2 min', tags: ['Biceps'] },
        ],
      },
      {
        day: 'Tisdag',
      ...
      },
      {
        ...
        focus: 'Bröst & Triceps',
        exercises: [
          { name: 'Barbell Bench Press', sets: '4', reps: '8', rest: '3 min', tags: ['Chest'] },
          { name: 'Smith Machine Incline Bench Press', sets: '3', reps: '8', rest: '2 min', tags: ['Chest'] },
          { name: 'Cable Upper Chest Crossover', sets: '3', reps: '8', rest: '90 sek', tags: ['Chest'] },
          { name: 'Tricep Pushdown V-Bar', sets: '3', reps: '8', rest: '90 sek', tags: ['Triceps'] },
          { name: 'Barbell Skull Crusher (reverse grip)', sets: '3', reps: '8', rest: '90 sek', tags: ['Triceps'] },
          { name: 'Close Grip Barbell Bench Press', sets: '3', reps: '8', rest: '2 min', tags: ['Triceps'] },
        ],
      },
      {
        day: 'Torsdag',
        ...
        focus: 'Ben',
        exercises: [
          { name: 'Barbell Squat', sets: '5', reps: '8', rest: '3 min', tags: ['Quads', 'Glutes'] },
          { name: 'Sumo Deadlift', sets: '4', reps: '6', rest: '3 min', tags: ['Hamstrings', 'Glutes'] },
          { name: 'Machine Leg Curl', sets: '4', reps: '8', rest: '2 min', tags: ['Hamstrings'] },
          { name: 'Machine Leg Extension', sets: '3', reps: '8', rest: '2 min', tags: ['Quads'] },
          { name: 'Machine Seated Calf Raise', sets: '3', reps: '8', rest: '90 sek', tags: ['Calves'] },
          { name: 'Bulgarian Split Squat', sets: '3', reps: '10', rest: '2 min', tags: ['Quads', 'Glutes'] },
        ],
      },
      {
        day: 'Fredag',
        muscleGroups: ['Biceps', 'Triceps'],
        focus: 'Armar (Renodlat)',
        exercises: [
          { name: 'Barbell Curl', sets: '4', reps: '8', rest: '2 min', tags: ['Biceps'] },
          { name: 'Dumbbell Alternating Hammer Curl', sets: '3', reps: '8', rest: '90 sek', tags: ['Biceps'] },
          { name: 'Barbell Preacher Curl', sets: '3', reps: '8', rest: '90 sek', tags: ['Biceps'] },
          { name: 'Barbell Skull Crusher (reverse grip)', sets: '3', reps: '8', rest: '2 min', tags: ['Triceps'] },
          { name: 'Tricep Pushdown V-Bar', sets: '3', reps: '8', rest: '90 sek', tags: ['Triceps'] },
          { name: 'Close Grip Barbell Bench Press', sets: '3', reps: '8', rest: '2 min', tags: ['Triceps'] },
        ],
      },
      {
        ...
        exercises: [
          { name: 'Barbell Bench Press', sets: '4', reps: '8', rest: '3 min', tags: ['Chest'] },
          { name: 'Dumbbell Incline Bench Press', sets: '3', reps: '8', rest: '2 min', tags: ['Chest'] },
          { name: 'Dumbbell Fly', sets: '3', reps: '8', rest: '90 sek', tags: ['Chest'] },
          { name: 'Machine Dip', sets: '3', reps: '8', rest: '90 sek', tags: ['Chest'] },
          { name: 'Machine Shoulder Press', sets: '4', reps: '8', rest: '2 min', tags: ['Shoulders'] },
          { name: 'Dumbbell Lateral Raise', sets: '4', reps: '8', rest: '90 sek', tags: ['Shoulders'] },
        ],
      },
      {
        day: 'Söndag',
    ...
    benefits: [
      '5 träningsdagar med vila tisdag och söndag. Tydliga vilotider per övning.',
      'Måndag Rygg&Biceps → Onsdag Bröst&Triceps → Torsdag Ben → Fredag Armar → Lördag Bröst&Axlar.',
    ],
  },
  {
    id: '13',
    ...
    difficulty: 'ADVANCED',
    duration: '8-12 WEEKS',
    focus: 'Classic bodybuilding volume',
    description: 'Arnold Schwarzeneggers klassiska split med hög volym och frekvens för maximal muskeltillväxt.',
    weeklyPlan: [
      {
        day: 'Måndag',
        muscleGroups: ['Chest', 'Back'],
        focus: 'Bröst & Rygg',
        exercises: [
          { name: 'Bench Press', sets: '4', reps: '10', rest: '90 sek', tags: ['Chest'], alternatives: ['Dumbbell Bench Press'] },
          { name: 'Incline DB Press', sets: '4', reps: '12', rest: '90 sek', tags: ['Chest'], alternatives: ['Incline Barbell Press'] },
          { name: 'DB Flyes', sets: '3', reps: '12', rest: '60 sek', tags: ['Chest'], alternatives: ['Cable Fly'] },
          { name: 'Pull-ups', sets: '4', reps: '10', rest: '90 sek', tags: ['Back'], alternatives: ['Lat Pulldown'] },
          { name: 'Barbell Row', sets: '4', reps: '10', rest: '90 sek', tags: ['Back'], alternatives: ['Dumbbell Row'] },
          { name: 'T-Bar Row', sets: '3', reps: '12', rest: '90 sek', tags: ['Back'], alternatives: ['Cable Row'] },
        ],
      },
      {
        day: 'Tisdag',
        ...
        focus: 'Axlar & Armar',
        exercises: [
          { name: 'Military Press', sets: '4', reps: '10', rest: '90 sek', tags: ['Shoulders'], alternatives: ['Dumbbell Shoulder Press'] },
          { name: 'Lateral Raise', sets: '4', reps: '12', rest: '60 sek', tags: ['Shoulders'] },
          { name: 'Rear Delt Fly', sets: '3', reps: '15', rest: '45 sek', tags: ['Shoulders'], alternatives: ['Face Pulls'] },
          { name: 'Barbell Curl', sets: '4', reps: '10', rest: '60 sek', tags: ['Biceps'] },
          { name: 'Skull Crushers', sets: '4', reps: '10', rest: '60 sek', tags: ['Triceps'] },
          { name: 'Hammer Curl', sets: '3', reps: '12', rest: '45 sek', tags: ['Biceps'] },
          { name: 'Tricep Pushdown', sets: '3', reps: '12', rest: '45 sek', tags: ['Triceps'] },
        ],
      },
      {
        day: 'Onsdag',
        ...
        focus: 'Ben',
        exercises: [
          { name: 'Back Squat', sets: '5', reps: '8', rest: '120 sek', tags: ['Quads', 'Glutes'] },
          { name: 'Leg Press', sets: '4', reps: '12', rest: '90 sek', tags: ['Quads'] },
          { name: 'Leg Curl', sets: '4', reps: '12', rest: '60 sek', tags: ['Hamstrings'] },
          { name: 'Leg Extension', sets: '4', reps: '12', rest: '60 sek', tags: ['Quads'] },
          { name: 'Calf Raise', sets: '5', reps: '15', rest: '45 sek', tags: ['Calves'] },
          { name: 'Romanian Deadlift', sets: '3', reps: '10', rest: '90 sek', tags: ['Hamstrings', 'Glutes'] },
        ],
      },
      {
        day: 'Torsdag',
        muscleGroups: ['Chest', 'Back'],
        focus: 'Bröst & Rygg (variation)',
        exercises: [
          { name: 'Dumbbell Bench Press', sets: '4', reps: '10', rest: '90 sek', tags: ['Chest'], notes: 'Variation från måndag' },
          { name: 'Cable Fly', sets: '4', reps: '12', rest: '60 sek', tags: ['Chest'] },
          { name: 'Incline Barbell Press', sets: '3', reps: '12', rest: '90 sek', tags: ['Chest'] },
          { name: 'Lat Pulldown', sets: '4', reps: '10', rest: '90 sek', tags: ['Back'] },
          { name: 'Dumbbell Row', sets: '4', reps: '10', rest: '90 sek', tags: ['Back'] },
          { name: 'Cable Row', sets: '3', reps: '12', rest: '60 sek', tags: ['Back'] },
        ],
      },
      {
        day: 'Fredag',
        ...
        focus: 'Axlar & Armar',
        exercises: [
          { name: 'Military Press', sets: '4', reps: '10', rest: '90 sek', tags: ['Shoulders'] },
          { name: 'Lateral Raise', sets: '4', reps: '12', rest: '60 sek', tags: ['Shoulders'] },
          { name: 'Rear Delt Fly', sets: '3', reps: '15', rest: '45 sek', tags: ['Shoulders'] },
          { name: 'Barbell Curl', sets: '4', reps: '10', rest: '60 sek', tags: ['Biceps'] },
          { name: 'Skull Crushers', sets: '4', reps: '10', rest: '60 sek', tags: ['Triceps'] },
          { name: 'Hammer Curl', sets: '3', reps: '12', rest: '45 sek', tags: ['Biceps'] },
          { name: 'Tricep Pushdown', sets: '3', reps: '12', rest: '45 sek', tags: ['Triceps'] },
      ...
      },
      {
        ...
        focus: 'Ben (variation)',
        exercises: [
          { name: 'Front Squat', sets: '5', reps: '8', rest: '120 sek', tags: ['Quads'], notes: 'Variation från onsdag' },
          { name: 'Hack Squat', sets: '4', reps: '12', rest: '90 sek', tags: ['Quads'] },
          { name: 'Leg Curl', sets: '4', reps: '12', rest: '60 sek', tags: ['Hamstrings'] },
          { name: 'Leg Extension', sets: '4', reps: '12', rest: '60 sek', tags: ['Quads'] },
          { name: 'Seated Calf Raise', sets: '5', reps: '15', rest: '45 sek', tags: ['Calves'] },
          { name: 'Stiff-Leg Deadlift', sets: '3', reps: '10', rest: '90 sek', tags: ['Hamstrings', 'Glutes'] },
        ],
      },
      {
        day: 'Söndag',
    ...
    benefits: [
      'Hög volym och frekvens – varje muskelgrupp tränas 2 gånger per vecka.',
      'Klassisk bodybuilding-split inspirerad av Arnold Schwarzenegger.',
      'Bra för erfarna lyftare som vill maximera muskeltillväxt.',
    ],
  },
  {
    id: '14',
    ...
    difficulty: 'INTERMEDIATE',
    duration: '12 WEEKS',
    focus: 'Power & hypertrophy kombination',
    description: 'Power Hypertrophy Upper Lower kombinerar styrketräning och hypertrofi för optimal muskeluppbyggnad.',
    weeklyPlan: [
      {
        day: 'Måndag',
        muscleGroups: ['Chest', 'Back', 'Shoulders', 'Biceps', 'Triceps'],
        focus: 'Upper Power',
        exercises: [
          { name: 'Bench Press', sets: '4', reps: '5', rest: '120 sek', tags: ['Chest'], notes: 'Tungt – fokus på styrka' },
          { name: 'Barbell Row', sets: '4', reps: '5', rest: '120 sek', tags: ['Back'] },
          { name: 'OHP', sets: '3', reps: '6', rest: '90 sek', tags: ['Shoulders'], alternatives: ['Dumbbell Shoulder Press'] },
          { name: 'Barbell Curl', sets: '3', reps: '8', rest: '60 sek', tags: ['Biceps'] },
          { name: 'Skull Crushers', sets: '3', reps: '8', rest: '60 sek', tags: ['Triceps'] },
        ],
      },
      {
        day: 'Tisdag',
        ...
        focus: 'Lower Power',
        exercises: [
          { name: 'Back Squat', sets: '4', reps: '5', rest: '120 sek', tags: ['Quads', 'Glutes'], notes: 'Tungt – fokus på styrka' },
          { name: 'Deadlift', sets: '4', reps: '5', rest: '120 sek', tags: ['Hamstrings', 'Back', 'Glutes'] },
          { name: 'Leg Press', sets: '3', reps: '8', rest: '90 sek', tags: ['Quads'] },
          { name: 'Leg Curl', sets: '3', reps: '8', rest: '60 sek', tags: ['Hamstrings'] },
          { name: 'Calf Raise', sets: '4', reps: '10', rest: '60 sek', tags: ['Calves'] },
        ],
      },
      {
        day: 'Onsdag',
      ...
      },
      {
        ...
        exercises: [
          { name: 'Incline DB Press', sets: '4', reps: '12', rest: '60 sek', tags: ['Chest'], notes: 'Lättare vikt – fokus på pump' },
          { name: 'Cable Row', sets: '4', reps: '12', rest: '60 sek', tags: ['Back'] },
          { name: 'Lateral Raise', sets: '4', reps: '15', rest: '45 sek', tags: ['Shoulders'] },
          { name: 'DB Curl', sets: '4', reps: '12', rest: '45 sek', tags: ['Biceps'] },
          { name: 'Tricep Pushdown', sets: '4', reps: '12', rest: '45 sek', tags: ['Triceps'] },
        ],
      },
      {
        day: 'Fredag',
        ...
        exercises: [
          { name: 'Front Squat', sets: '4', reps: '12', rest: '90 sek', tags: ['Quads'], notes: 'Lättare vikt – fokus på pump' },
          { name: 'Romanian Deadlift', sets: '4', reps: '12', rest: '90 sek', tags: ['Hamstrings', 'Glutes'] },
          { name: 'Leg Extension', sets: '4', reps: '15', rest: '45 sek', tags: ['Quads'] },
          { name: 'Leg Curl', sets: '4', reps: '15', rest: '45 sek', tags: ['Hamstrings'] },
          { name: 'Calf Raise', sets: '4', reps: '15', rest: '45 sek', tags: ['Calves'] },
        ],
      },
      {
        day: 'Lördag',
    ...
    benefits: [
      'Kombinerar styrka och hypertrofi – bästa av två världar.',
      'Överkropp och underkropp tränas 2 gånger per vecka.',
      'Passar intermediate-lyftare som vill bli både starkare och större.',
    ],
  },
  {
    id: '15',
    ...
    difficulty: 'INTERMEDIATE',
    duration: 'ONGOING',
    focus: 'Linear progression styrkeprogram',
    description: 'nSuns 5/3/1 LP är ett populärt styrkeprogram baserat på Jim Wendlers 5/3/1 med högre volym och snabbare progression.',
    weeklyPlan: [
      {
        day: 'Måndag',
        muscleGroups: ['Chest', 'Shoulders'],
        focus: 'Bench & OHP',
        exercises: [
          { name: 'Bench Press', sets: '9', reps: '5/3/1/3/3/5/5/8+', rest: '90 sek', tags: ['Chest'], notes: 'T1 – huvudlyft, progressiva vikter' },
          { name: 'OHP', sets: '8', reps: '6/5/3/5/7/4/6/8+', rest: '90 sek', tags: ['Shoulders'], notes: 'T2 – sekundärt lyft' },
        ],
      },
      {
        day: 'Tisdag',
        muscleGroups: ['Quads', 'Hamstrings', 'Glutes'],
        focus: 'Squat & Sumo Deadlift',
        exercises: [
          { name: 'Back Squat', sets: '9', reps: '5/3/1/3/3/5/5/8+', rest: '120 sek', tags: ['Quads', 'Glutes'], notes: 'T1 – huvudlyft' },
          { name: 'Sumo Deadlift', sets: '8', reps: '6/5/3/5/7/4/6/8+', rest: '120 sek', tags: ['Hamstrings', 'Glutes'], notes: 'T2 – sekundärt lyft' },
        ],
      },
      {
        day: 'Onsdag',
        muscleGroups: ['Shoulders', 'Chest'],
        focus: 'OHP & Incline Bench',
        exercises: [
          { name: 'OHP', sets: '9', reps: '5/3/1/3/3/5/5/8+', rest: '90 sek', tags: ['Shoulders'], notes: 'T1 – huvudlyft' },
          { name: 'Incline Bench Press', sets: '8', reps: '6/5/3/5/7/4/6/8+', rest: '90 sek', tags: ['Chest'], notes: 'T2 – sekundärt lyft' },
        ],
      },
      {
        day: 'Torsdag',
        muscleGroups: ['Hamstrings', 'Back', 'Quads'],
        focus: 'Deadlift & Front Squat',
        exercises: [
          { name: 'Deadlift', sets: '9', reps: '5/3/1/3/3/5/5/8+', rest: '120 sek', tags: ['Hamstrings', 'Back', 'Glutes'], notes: 'T1 – huvudlyft' },
          { name: 'Front Squat', sets: '8', reps: '6/5/3/5/7/4/6/8+', rest: '90 sek', tags: ['Quads'], notes: 'T2 – sekundärt lyft' },
        ],
      },
      {
        day: 'Fredag',
        muscleGroups: ['Chest', 'Triceps'],
        focus: 'Bench & Close Grip Bench',
        exercises: [
          { name: 'Bench Press', sets: '9', reps: '5/3/1/3/3/5/5/8+', rest: '90 sek', tags: ['Chest'], notes: 'T1 – huvudlyft' },
          { name: 'Close Grip Bench Press', sets: '8', reps: '6/5/3/5/7/4/6/8+', rest: '90 sek', tags: ['Triceps', 'Chest'], notes: 'T2 – sekundärt lyft' },
        ],
      },
      {
        day: 'Lördag',
    ...
    benefits: [
      'Snabb styrkeökning genom linjär progression.',
      'Hög volym på de stora lyften – Bench, Squat, Deadlift, OHP.',
      'Lägg till valfria accessory-övningar efter T1/T2 varje dag.',
    ],
  }
];
