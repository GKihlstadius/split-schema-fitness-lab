...
const XPPopup: React.FC<XPPopupProps> = ({ amount, description, onComplete }) => {
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center rounded-2xl bg-white border border-gray-200 px-6 py-3 shadow-lg">
        <span className="text-2xl font-bold text-emerald-600">+{amount} XP</span>
