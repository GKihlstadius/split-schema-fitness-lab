        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
              ...
              <div className="space-y-4 p-4 sm:p-6 border border-border rounded-xl bg-card">
                ...
                <div className="grid grid-cols-2 gap-3 sm:gap-4 text-center">
                  <div className="p-3 sm:p-0">
                    <div className="text-xl sm:text-2xl font-bold text-primary">{targetKcal}</div>
                    <div className="text-xs sm:text-sm text-muted-foreground">Kalorier</div>
                  </div>
                  <div className="p-3 sm:p-0">
                    <div className="text-xl sm:text-2xl font-bold text-primary">{targetProtein}g</div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  {currentMeal.items.map(item => {
                    ...
                    const multiplier = item.grams / 100;
                    return (
                      <div key={item.id} className="p-4 border border-border rounded-xl bg-card">
                        <div className="space-y-3">
              ...
              <div className="space-y-4 p-4 sm:p-6 border border-border rounded-xl bg-card">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                  {quickMeals.slice(0, 6).map(meal => (
                    <div key={meal.id} className="p-3 bg-card border border-border rounded-xl hover:bg-secondary transition-colors">
              ...
              <>
                ...
                <div className="space-y-4 p-4 sm:p-6 border border-border rounded-xl bg-card">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div className="space-y-2 p-3 sm:p-0 border border-border sm:border-0 rounded-xl sm:rounded-none">
                ...
                <div className="space-y-3">
                  ...
                  {dailyMeals.map((meal, index) => (
                    <Card key={meal.id} className="border-border bg-card rounded-2xl">
          ...
          <TabsContent value="saved" className="space-y-4 mt-4 sm:mt-6">
            {quickMeals.length === 0 ? (
              ...
              <div className="grid grid-cols-1 gap-4">
                {quickMeals.map(meal => (
                  <Card key={meal.id} className="border-border bg-card rounded-2xl cursor-pointer hover:bg-secondary transition-colors">
