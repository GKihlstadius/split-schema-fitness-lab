...
export const SimplifiedMealPlanner: React.FC<SimplifiedMealPlannerProps> = ({
  ...
  return (
    <div className="max-w-7xl px-4 sm:px-6 py-4 sm:py-8">
      ...
      <Card className="border-gray-100 bg-white rounded-2xl">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="goals" className="space-y-4 sm:space-y-6 mt-4 sm:mt-6">
            <div className="space-y-4 p-4 sm:p-6 border border-gray-100 rounded-xl bg-white">
              ...
              <div className="space-y-4 p-4 sm:p-6 border border-gray-100 rounded-xl bg-white">
                ...
                <div className="grid grid-cols-2 gap-3 sm:gap-4 text-center">
                  <div className="p-3 sm:p-0">
                    <div className="text-xl sm:text-2xl font-bold text-emerald-600">{targetKcal}</div>
                    <div className="text-xs sm:text-sm text-muted-foreground">Kalorier</div>
                  </div>
                  <div className="p-3 sm:p-0">
                    <div className="text-xl sm:text-2xl font-bold text-emerald-600">{targetProtein}g</div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  {currentMeal.items.map(item => {
                    ...
                    const multiplier = item.grams / 100;
                    return (
                      <div key={item.id} className="p-4 border border-gray-100 rounded-xl bg-white">
                        <div className="space-y-3">
                ...
                <div className="p-4 sm:p-6 border border-gray-100 rounded-xl bg-white">
              ...
              <div className="space-y-4 p-4 sm:p-6 border border-gray-100 rounded-xl bg-white">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                  {quickMeals.slice(0, 6).map(meal => (
                    <div key={meal.id} className="p-3 bg-white border border-gray-100 rounded-xl hover:bg-gray-100 transition-colors">
              ...
              <>
                ...
                <div className="space-y-4 p-4 sm:p-6 border border-gray-100 rounded-xl bg-white">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div className="space-y-2 p-3 sm:p-0 border border-gray-100 sm:border-0 rounded-xl sm:rounded-none">
                ...
                <div className="space-y-3">
                  ...
                  {dailyMeals.map((meal, index) => (
                    <Card key={meal.id} className="border-gray-100 bg-white rounded-2xl">
          ...
          <TabsContent value="saved" className="space-y-4 mt-4 sm:mt-6">
            {quickMeals.length === 0 ? (
              ...
              <div className="grid grid-cols-1 gap-4">
                {quickMeals.map(meal => (
                  <Card key={meal.id} className="border-gray-100 bg-white rounded-2xl cursor-pointer hover:bg-gray-100 transition-colors">
