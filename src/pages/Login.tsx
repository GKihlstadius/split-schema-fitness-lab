            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 bg-muted border-border focus:border-primary/30 rounded-xl h-11"
                  disabled={isLoading}
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  onChange={handleInputChange}
                  className="pr-10 bg-muted border-border focus:border-primary/30 rounded-xl h-11"
                  disabled={isLoading}
                />
                <Button
                  type="button"
            ...
            {isRegistering && (
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={handleInputChange}
                  className="bg-muted border-border focus:border-primary/30 rounded-xl h-11"
                  disabled={isLoading}
                />
              </div>
            )}
